...
<div class="auth-card">
    ...
    <?php if($success): ?>
        ...
        <div class="text-center mt-4">
            <a href="/tsdhhl26/" class="btn btn-brand w-100 py-2 fw-semibold">QUAY LẠI ĐĂNG NHẬP</a>
        </div>
    <?php else: ?>
    ...
    <div class="text-center mt-4 pt-3 border-top pb-1">
        <a href="/tsdhhl26/" class="text-decoration-none fw-semibold text-muted small">← Về trang Đăng nhập</a>
    </div>
