...
<body>
    ...
    <div class="page-wrapper">
        <div class="auth-card">
            ...
            <?php if ($success): ?>
                <div class="alert alert-success py-3 rounded-1 border-0 bg-success text-white small"><?php echo $success; ?>
                </div>
            ...
            <?php else: ?>
                ...
                <form method="POST" action="">
                    ...
                    <div class="alert bg-light border-0 small text-muted mb-4">
                        Để cấp lại mật khẩu, vui lòng nhập chính xác Tên đăng nhập và Số CMND/CCCD khớp với Hồ sơ
                        đã đăng ký.
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold">Số CMND / Thẻ Căn Cước <span
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Mật khẩu thiết lập mới <span
                                class="text-danger">*</span></label>
                ...
                <div class="text-center mt-4 pt-3 border-top pb-1">
                    <a href="<?php echo BASE_URL; ?>/" class="text-decoration-none fw-semibold text-muted small">← Về trang
                        Đăng nhập</a>
                </div>
